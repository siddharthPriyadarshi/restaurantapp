...
const Header = () => {
    ...
    return (
        <header className="fixed w-screen bg-slate-300 p-3 md:pd-6 md:px-16 ">
            {/* desktop and tablet */}
                        ...
                        isMenu && (
                            <motion.div initial={{ opacity: 0, scale: 0.6 }}
                                ...
                                <ul className="flex flex-col ">
                                    <li className="text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out hover:bg-slate-100 px-4 py-2">Menu</li>
                                    <li className="text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out hover:bg-slate-100 px-4 py-2">About Us</li>
                                ...
                                <p className="m-2 p-2 rounded-md shadow-md flex items-center bg-gray-200 gap-3 cursor-pointer hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base justify-center"
