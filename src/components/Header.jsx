...
const Header = () => {
  ...
  return (
    <header className="z-10 fixed w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      {/* desktop and tablet */}
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col ">
                <li
                  className="text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out hover:bg-slate-100 px-4 py-2"
                  onClick={() => setIsMenu(false)}
                >
                  Menu
                </li>
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center bg-gray-200 gap-3 cursor-pointer hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base justify-center"
                onClick={logout}
              >
                Logout <MdLogout />
              </p>
